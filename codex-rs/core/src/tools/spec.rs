...
fn create_grep_files_tool() -> ToolSpec {
    let properties = BTreeMap::from([
        ...
        (
            ...
            JsonSchema::Boolean {
                description: Some(
                    "Whether to include hidden files and directories (such as .git). Defaults to false; set to true only when the user explicitly requests searching hidden files."
                        .to_string(),
                ),
            },
        ),
...
fn create_read_file_tool() -> ToolSpec {
    let indentation_properties = BTreeMap::from([
        ...
        (
            ...
            JsonSchema::Boolean {
                description: Some("Include doc comments or attributes directly above the selected block.".to_string()),
            },
        ),
        (
            "include_siblings".to_string(),
            JsonSchema::Boolean {
                description: Some("When true, include additional blocks that share the anchor indentation.".to_string()),
            },
        ),
        (
            "max_levels".to_string(),
            JsonSchema::Number {
                description: Some("How many parent indentation levels (smaller indents) to include.".to_string()),
            },
        ),
        (
            "max_lines".to_string(),
            JsonSchema::Number {
                description: Some("Hard cap on the number of lines returned when using indentation mode.".to_string()),
            },
        ),
    ]);
    ...
    let properties = BTreeMap::from([
        ...
        (
            "mode".to_string(),
            JsonSchema::String {
                description: Some("Optional mode selector: \"slice\" for simple ranges (default) or \"indentation\" to expand around an anchor line.".to_string()),
            },
        ),
        (
