...
/// Run Codex with custom I/O streams.
///
/// This allows embedding Codex in other applications without spawning a separate process.
/// It reuses the same logic as `run_main` but accepts custom streams instead of stdin/stdout.
